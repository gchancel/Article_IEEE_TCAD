...
%		presented a low-cost BBI platform, dedicated to WLCSP devices \cite{bbiColin}.
		...
		Therefore, they developed a custom tool called a high-voltage pulse injector (HVPI), equipped with a transformer, controller through a NMOS transistor.
		...
		Then, \cite{mybbiFdtc2022} studied the impact of dual-well and triple-well substrate types on BBI induced effects, and \cite{mybbifdtc2023} proposed better practices for BBI platform design while studying a logic gate level model of BBI.
