...
%	Our work is dedicated in studying Body Biasing Injection.
	...
	\subsection{Fault injection objectives}
		...
		\end{itemize}
		To perform these objectives, an attacker can use the previously mentioned injection methods, such as EMFI, LFI or BBI.
...
%
		...
		In addition to this, it introduced a dual-well substrate lumped model for BBI attacks.
