...
%
		...
		The original work \cite{bbiOrigin} introduced the technique for the first time using an ASIC embedding counter-measures and performing a Bellcore attack \cite{bellcore}, as this attack has weak fault requirements, on a modular exponentiation using an arithmetic co-processor.
