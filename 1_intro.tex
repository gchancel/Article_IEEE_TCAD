...
%
		...
		The original work \cite{bbiOrigin} introduced the technique and demonstrated the feasibility of a Bellcore attack on the targeted IC, as the Bellcore attack does not have strong fault requirements.
