...
\subsection{An hybrid simulation flow: analyzing the results}
	...
	\subsubsection{Positive dual-well simulation results}
	...
	\subsubsection{Differences between dual-well and triple-well (negative and positive pulses)}
		...
		On the triple-well side, the top of the SCS is barred with a first P-N diode (P-substrate N-well), and the PMOS are behind another diode.
