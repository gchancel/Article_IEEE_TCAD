...
\subsection{An hybrid simulation flow: analyzing the results}
	...
	\subsubsection{Negative dual-well simulation results}
		...
		Sub-fig. \ref{sim_res_dw_neg}(a) represents the power delivery network across the entire IC as seen from above.
		The external power connections are made at the top and bottom of the IC, and
