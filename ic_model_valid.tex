...
\subsection{BBI effects on dynamic logic gates: DFF}
	...
	The flip-flop is directed by a 40 MHz clock, and we perform three write operations with alternating voltage levels (H \textrightarrow\ L \textrightarrow\ H), to finally let it rest at a high logic level.
