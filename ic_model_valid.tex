...
\subsection{BBI effects on dynamic logic gates: DFF \textcolor{orange}{To re-write}}
...
%	During these simulations, we initialize the DFF with a low logic level, then a 
	...
	\subsubsection{Dual-well substrate, negative pulse}
		...
		\input{./figures/dff-dw-neg-dyn.tex}
	...
	\subsubsection{Triple-well substrate, negative pulse}
		\input{./figures/dff-tw-neg.tex}
		Fig. \ref{dffstatic-tw} shows the simulati1 on results for a triple-well negative pulse for a steady state disturbed DFF.
		...
		\input{./figures/dff-tw-neg-dyn.tex}
