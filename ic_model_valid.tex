...
\subsection{Completing the models}
	...
	\input{./figures/fig_ivxmos}
		Because inverters can have two stable output states, we will consider two cases for each substrate scenario, as it is illustrated on the model shown in Fig. \ref{ivxbufmos}.
